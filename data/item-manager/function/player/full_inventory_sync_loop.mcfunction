...
execute unless score #current_replacements item_manager.counter matches 1.. run tellraw @s [{"text":"DEBUG: Finished inventory sync, total replacements: ","color":"yellow"},{"score":{"name":"#replacements_made","objective":"item_manager.counter"},"color":"white"}]