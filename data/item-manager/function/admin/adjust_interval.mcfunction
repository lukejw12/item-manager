...
$execute if score #1 item_manager.counter matches $(change) run scoreboard players add #current_interval item_manager.counter 1
$execute if score #-1 item_manager.counter matches $(change) run scoreboard players remove #current_interval item_manager.counter 1
